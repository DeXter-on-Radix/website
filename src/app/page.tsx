  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 xl:grid-cols-9 col-span-12 xl:col-span-9">
        ...
        <div className="col-span-12 min-h-[200px] lg:col-span-7 xl:col-span-6 order-1 lg:order-2 text-center border-b-4 sm:border-b-4 lg:border-b-0 border-base-300">
          <PriceChart />
        </div>
      </div>
