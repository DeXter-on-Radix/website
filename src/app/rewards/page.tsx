...
function HeaderComponent() {
  ...
  return (
    <div className="h-full">
      <div className="h-full max-w-[600px] flex m-auto">
        <div className="text-left text-white p-4 w-[65%]">
          <div className="flex flex-col justify-around h-full">
            <h2
              className="text-md m-0"
              style={{ margin: 0, fontSize: "45px", fontWeight: "regular" }}
            >
              Rewards
            </h2>
            <p className="text-sm">{t("earn_rewards_by")}</p>
            <p className="text-sm">{t("rewards_distribution")}</p>
          </div>
        </div>
        <div className="w-[35%]">
          <img
            ...
            width={218}
          />
          {/* Assuming you have the right section as a separate component or image */}
          {/* Insert the right section component or image here */}
        </div>
      </div>
    </div>
  );
